...
| Test URL              | https://preview.c9users.io/lautr3k/chilipeppr-meshes-widget/widget.html |
...
$("body").append('<' + 'div id="myDivChOnlfaitChilipepprMeshesWidget"><' + '/div>');
...
instantiating code like a workspace or a different widget.</td></tr><tr valign="top"><td>dropSetup</td><td>function</td><td>function () <br><br>Setup drag/drop on body.</td></tr><tr valign="top"><td>onDrop</td><td>function</td><td>function (files) <br><br>On file(s) dropped.</td></tr><tr valign="top"><td>loadedFiles</td><td>object</td><td>Loaded files collection.</td></tr><tr valign="top"><td>loadFile</td><td>function</td><td>function (file) <br><br>Try to load a file (for now only STL).</td></tr><tr valign="top"><td>forkSetup</td><td>function</td><td>function () <br><br>This method loads the pubsubviewer widget which attaches to our 
...
events.</td></tr><tr valign="top"><td>btnSetup</td><td>function</td><td>function () <br><br>Call this method from init to setup all the buttons when this widget
is first loaded. This basically attaches click events to your 
buttons. It also turns on all the bootstrap popovers by scanning
the entire DOM of the widget.</td></tr><tr valign="top"><td>showBody</td><td>function</td><td>function (evt)  <br><br>Show the body of the panel.
...
load so we can reset the user's preference. If you don't pass this 
value in we don't store the preference because it was likely code 
that sent in the param.</td></tr><tr valign="top"><td>options</td><td>object</td><td>User options are available in this property for reference by your
