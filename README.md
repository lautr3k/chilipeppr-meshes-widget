...
instantiating code like a workspace or a different widget.</td></tr><tr valign="top"><td>btnSetup</td><td>function</td><td>function ()  console.log('dddddddddddddddd');<br><br>Call this method from init to setup all the buttons when this widget
